# Wine Quality MLflow Multi-Model Example
...
if __name__ == "__main__":
    ...
    # Logistic Regression needs classification target
    train_y_class = (train_y >= 6).astype(int)
    test_y_class = (test_y >= 6).astype(int)

    # ==============================
    # MLflow tracking (AWS or local)
    # ==============================
    ...
    for model_name, model in models.items():
        ...
        with mlflow.start_run(run_name=model_name):
            ...
            if model_name == "LogisticRegression":
                ...
                accuracy = (predictions == test_y_class).mean()
